...
|---------|-------|-------------|---------|-----------|
| T-027.12 | @Claude | Push safety (explicit refspecs, --no-track worktrees) after a push reached a consumer's main; frozen Done IDs no longer block migration | 2026-09-15 | 1 |
